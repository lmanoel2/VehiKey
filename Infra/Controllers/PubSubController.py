...
from Infra.Views.Request.PubSubRequestView import PubSubRequestView
...
class StreamController(BaseController):
    ...
    def Publish():
        try:
            pubSubView = PubSubRequestView.parse_raw(request.data)

            clientPubSub.Publish(pubSubView.action, pubSubView.topic_suffix)
